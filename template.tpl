...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Google Data Manager + BQ by ROAS Architects",
  "categories": [
    "ADVERTISING",
    "ANALYTICS",
    "CONVERSIONS"
  ...
  "description": "Sends conversion events to Google Ads, Campaign Manager 360, Search Ads 360, Display & Video 360 and Google Analytics through the Data Manager API, and logs every request and response to BigQuery so a failing upload is queryable rather than silent. The Stape container API key is masked in logged URLs.",
  "containerContexts": [
    "SERVER"
  ]
}
